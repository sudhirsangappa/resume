...
\begin{resume}
    ...
    \begin{list2}
    \item I acted as an Engineering Lead (mixed development and project
          management) for the Workstation 8.0 release. I personally designed and
          implemented the Workstation as a Server, remote connectivity, and VM
          library features. Several of these features required working closely
          with people from across different business units and aligning goals
          between different product lines. I also helped set schedules, organize
          cross-functional teams, and guide the release through completion.
